...
| `PRODUCTIVITY_REVIEW_ENABLED` | `true` | Set to `false` to skip automatic productivity-review reconciliation at startup and during scheduled heartbeat recovery. Existing review tasks are unchanged. |
